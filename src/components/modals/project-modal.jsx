...
export const ProjectModal = ({
  ...
  const content = (
    <div
      className="fixed inset-0 z-[100] px-4 py-12 bg-zinc-950/50 backdrop-blur overflow-y-scroll flex justify-center cursor-pointer"
          ...
          <div>
            ...
            <div className="flex items-center gap-4 text-sm">
              <Link
                target="_blank"
                rel="nofollow"
                className="text-zinc-300 hover:text-indigo-500 transition-colors flex items-center gap-1"
                to={code}
              >
