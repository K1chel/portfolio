  ...
  return (
    <>
      ...
      <div id="projects" className="relative z-50 mt-[20rem] mb-10">
        ...
        <div className="absolute lg:h-[170vh] md:h-[180vh] h-[250vh] bottom-0 left-0 -z-10 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
        <div className="z-50">
          <Projects />
        </div>
      </div>
